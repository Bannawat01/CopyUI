...
const FAQ_BY_LOCALE: Record<Locale, FaqItem[]> = {
  ...
  th: [
    ...
    {
      question: "โหมด Retheme จะลบโค้ดเดิมของฉันไหม?",
      answer:
        "โหมด Retheme ออกแบบมาให้คง route, logic, state, การเรียก API, event handler และพฤติกรรมเดิมไว้ และเปลี่ยนเฉพาะสไตล์ที่มองเห็น แต่มันก็ยังเป็นเครื่องมือ AI ซึ่งยังผิดพลาดได้ ควร commit หรือแยก branch ก่อนให้ AI แก้ไฟล์ และตรวจสอบ diff ทุกครั้งก่อนยอมรับการเปลี่ยนแปลง นั่นคือสิ่งที่ปกป้องโค้ดคุณจริง ๆ ไม่ใช่ถ้อยคำใน prompt ของเรา",
    },
    {
      question: "ควรใช้รูปแบบการทำงานแบบไหนกับโปรเจกต์เดิม?",
      answer:
        "ถ้าโค้ดเบสใหญ่หรือมีความเสี่ยง ให้เลือก 'บอกวิธีเท่านั้น' เครื่องมือจะอธิบายการเปลี่ยนแปลงและคุณลงมือเอง เลือก 'แก้ไขไฟล์เลย' เฉพาะเมื่อคุณสบายใจที่จะให้เครื่องมือแก้ไฟล์ และมี commit ที่สะอาดรองรับแล้ว",
    },
    {
  ...
  "zh-CN": [
    ...
    {
      question: "Retheme 模式会删除我现有的代码吗？",
      answer:
        "Retheme 模式旨在保留你现有的路由、逻辑、状态、API 调用、事件处理与行为，只改变视觉样式。但它仍然是 AI 工具，而 AI 会犯错。让 AI 动手之前请先 commit 或新建分支，并在接受改动前审查 diff — 这才是真正保护你代码的东西，而不是我们的提示词措辞。",
    },
    {
...
const RETHEME_POINTS_BY_LOCALE: Record<Locale, string[]> = {
  ...
  th: [
    "prompt นี้ออกแบบมาให้คง route, logic, state, การเรียก API, event handler และพฤติกรรมเดิมไว้ และเปลี่ยนเฉพาะสไตล์ที่มองเห็นเท่านั้น",
    "AI ยังผิดพลาดได้ ควร commit หรือแยก branch ก่อน แล้วตรวจสอบ diff ก่อนยอมรับการเปลี่ยนแปลงเสมอ",
    "ถ้าโปรเจกต์ใหญ่หรือมีความเสี่ยง ให้เลือก 'บอกวิธีเท่านั้น' เลือก 'แก้ไขไฟล์เลย' เฉพาะเมื่อคุณสบายใจที่จะให้เครื่องมือแก้ไฟล์",
  ],
  "zh-CN": [
    "该提示词旨在保留你的路由、逻辑、状态、API 调用、事件处理与行为，仅改变视觉样式。",
    "AI 仍会犯错。请先 commit 或新建分支，并在接受改动前审查 diff。",
